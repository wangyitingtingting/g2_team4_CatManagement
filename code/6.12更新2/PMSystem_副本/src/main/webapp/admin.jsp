<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
                ...
                <div class="nav">
                    <ul>
                        <li class="list">
                            <h2><i></i>宠物信息管理</h2>
                            <div  class="hide">
                                <h5><i></i><a href="show.jsp">猫</a></h5>
                                <h5><i></i><a href="show.jsp">狗</a></h5>
                            </div>
                        </li>
                        <li class="list">
            ...
            <div id="adoptionSection" class="admin" style="display: none">
                <h2>申请领养列表</h2>
                <table>
                    <thead>
                    <tr>
                    ...
                    <c:forEach var="adoption" items="${requestScope.adoptions}">
                        <tr>
                            ...
                            <td>
                                <button type="button" onclick="approveAdoption('${adoption.id}', '1')">同意</button>
                                <button type="button" onclick="approveAdoption('${adoption.id}', '0')">拒绝</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <script>
                ...
                function approveAdoption(id, isApproved) {
                    var action = isApproved ? 'approve' : 'reject';
                    var message = isApproved ? '同意' : '拒绝';
                    if (confirm('是否' + message + '此领养申请?')) {
                        $.ajax({
