...
@WebServlet("/updateAnimalByIdServlet")
public class updateAnimalByIdServlet extends HttpServlet {
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fimage="";
		if(!"".equals(fn)) {fimage=relpath+"/"+fn;}
       ...
       /* String AnimalId = req.getParameter("AnimalId");
        Integer id = Integer.valueOf(AnimalId);
		...
		String AnimalId = param.get("AnimalId").toString(); 
		Integer id = Integer.valueOf(AnimalId);
        ...
        AnimalService.updateAnimalById(a);
