    ...
    <table>
        ...
        <c:forEach var="adoption" items="${requestScope.adoptions}">
            <tr>
                ...
                <td>
                    <button type="button" onclick="approveAdoption('${adoption.animalName}', '${adoption.reason}', '${adoption.approved}', '${adoption.userName}')">领养</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<script>
    ...
    function confirmResult(flag) {
        ...
        $.ajax({
            url: '/adoptionAction',
            method: "post",
            data: { 'animalName': animalName, 'action': flag , 'reason': reason,'userName':userName},
            success: function () {
                location.href = "/adoptionManage";
            }
        })
    ...
    function approveAdoption(animalNameTemp, reasonTemp, approvedTemp, userNameTemp) {
