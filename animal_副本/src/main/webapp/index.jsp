...
<div class="page">
  <div class="top">
    <div><img src="images/logo.jpg"/>ANIMAL HOME</div>
    <ul class="menu">
      <li><a href="index">首页1s</a></li>
  ...
  <div class="cp">
    <h1>关于我们</h1>
    <div class="js_pic"><img src="images/about.png" width="400"/></div>
  ...
  <div class="cp_zs">
    ...
    <ul>
      <li>
        <p><a href="#"><img src="images/cp1.png"/></a></p>
        <p><strong>小白</strong></p>
        
      </li>
      <li>
        <p><a href="#"><img src="images/cp2.png"/></a></p>
        <p><strong>小黄</strong></p>
        
      </li>
      <li>
  <p><a href="#"><img src="images/cp3.png"/></a></p>
        <p><strong>小小白</strong></p>
       
      </li>
      <li>
        <p><a href="#"><img src="images/cp4.png"/></a></p>
  ...
  <div class="news">
    <div class="pic"><img src="images/news.png"/></div>
    <div class="list">
      <div class="title">
        <h1>新闻动态</h1>
      </div>
